package com.rkis.gpsspeedo4.prefs;
...
public class PrefUtils
{
	...
	public static boolean getPrefFSensorLpfLinearAccelerationEnabled(Context context) {
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getBoolean(FilterConfigActivity.FSENSOR_LPF_LINEAR_ACCEL_ENABLED_KEY, true);
	}
    ...
    public static boolean getPrefMeanFilterSmoothingEnabled(Context context) {
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getBoolean(FilterConfigActivity.MEAN_FILTER_SMOOTHING_ENABLED_KEY, true);
	}
    ...
    public static boolean getPrefMedianFilterSmoothingEnabled(Context context) {
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return prefs.getBoolean(FilterConfigActivity.MEDIAN_FILTER_SMOOTHING_ENABLED_KEY, true);
	}
